...
def home(request):
    ...
    context ={}
    api_key = os.getenv("sk-proj-3LJCsRlEiONN0y8hDt7IT3BlbkFJOQnUeqofksPwhTTUJwfR")
...
def register(request):
    if request.method =="POST":
        ...
        print("POST DATA RECEIVED :" , first_name , last_name, username , password)
...
def dashboard(request):
    ...
    return render (request, "dashoard.html", context)
